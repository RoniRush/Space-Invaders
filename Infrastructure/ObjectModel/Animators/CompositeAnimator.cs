...
namespace Infrastructure.ObjectModel.Animators
{
     ...
     public class CompositeAnimator : SpriteAnimator
     {
          ...
          public List<SpriteAnimator> AnimationsList
          {
               get
               {
                    return this.r_AnimationsList;
               }
          }
          ...
          public void Add(SpriteAnimator i_Animation)
          {
               ...
               i_Animation.Enabled = false;
               this.r_AnimationsDictionary.Add(i_Animation.Name, i_Animation);
               this.r_AnimationsList.Add(i_Animation);
          }

          public void Remove(string i_AnimationName)
          {
               SpriteAnimator animationToRemove;
               this.r_AnimationsDictionary.TryGetValue(i_AnimationName, out animationToRemove);
               if (animationToRemove != null)
               {
                    this.r_AnimationsDictionary.Remove(i_AnimationName);
                    this.r_AnimationsList.Remove(animationToRemove);
               }
          }
          ...
          public SpriteAnimator this[string i_Name]
          {
               get
               {
                    ...
                    this.r_AnimationsDictionary.TryGetValue(i_Name, out retVal);
                    return retVal;
               }
          }
          ...
          public override void Restart()
          {
               ...
               foreach (SpriteAnimator animation in this.r_AnimationsList)
               {
                    animation.Restart();
               }
          }
